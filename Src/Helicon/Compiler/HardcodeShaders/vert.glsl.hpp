...
static inline ::EmbeddedShader::FunctionProxy<void()> main{"main","void",{},&C__Users_12168_Documents_work_space_CabbageHardware_Examples_vert_glsl};
struct gl_PerVertex
{
